...
CREATE INDEX account_detail_index ON "account_detail" ("user_id");

ALTER TABLE "account_detail" ADD CONSTRAINT account_detail_user FOREIGN KEY ("user_id") REFERENCES "account" ("id");
